...
// ==================== WINDOW SEARCH OVERLAY ====================
// Fullscreen, modal, Solarized Dark search overlay opened from a
// WindowOverflowButton (6+ window mode). Never mutates window/workspace
// ordering or state — purely a display and activation surface. Search
// results are draggable and represent the real window.
export class WindowSearchOverlay {
    ...
    _setResults(results) {
        ...
        results.forEach((item, index) => {
            ...
            // (source.realWindow -> a Meta.WindowActor), matching the same
            // protocol getDraggedWindow() understands.
    ...
    // Closing from the preview closes the real window and just prunes it
    ...
    // i.e. this is a real drag, not a click.
