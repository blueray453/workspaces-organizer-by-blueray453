...
export class WindowIconButton extends St.Button {
    ...
    constructor(window, settings) {
        ...
        this._hoverPreview = new WindowHoverPreview(this, window, settings, {
            onHoverChange: isHovered => this._onPreviewHoverChange(isHovered),
        });
        this._titlePopup = new WindowTitlePopup(this, window, settings, {
            onHoverChange: isHovered => this._onPreviewHoverChange(isHovered),
        });
    ...
    // ---- public surface used by collaborators ----
    get window() {
        return this._window;
    }
