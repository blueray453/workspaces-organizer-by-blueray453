...
class WindowHoverPreview {
    ...
    show() {
        ...
        this._previewActor.ease({ opacity: 255, duration: TimeoutDelay, mode: Clutter.AnimationMode.EASE_OUT_QUAD });
...
class WindowTitlePopup {
    ...
    show() {
        ...
        label.opacity = 0;
        label.ease({ opacity: 255, duration: TimeoutDelay, mode: Clutter.AnimationMode.EASE_OUT_QUAD });
