...
export class WorkspaceIndicator extends PanelMenu.Button {
    ...
    constructor(settings) {
        ...
        // Create the icons first so we can update their size later
        ...
        this._drunButton = this._makeToolbarButton(this._drunIcon, 'Show apps', () => this._launchGdmenu(['--drun', '--fullscreen']));
        this._windowButton = this._makeToolbarButton(this._windowIcon, 'All windows', () => this._launchGdmenu(['--window', '--fullscreen']));
