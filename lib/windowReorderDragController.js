...
export const WindowReorderDragController = {
    ...
    _acceptSameWorkspace(targetThumbnail, draggedWindow, actor, insertIndex) {
        ...
        // Suppress the automatic sync() that reorderWindowToIndex would
        // otherwise trigger — we place `actor` ourselves below, and letting
        // syncChildOrder() run first would reparent it out of uiGroup
        // itself, racing with our own settle/insert logic.
